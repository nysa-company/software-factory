...
run_suite "operator console security suite" python3 "$ROOT/ci/operator-console-test.py"
...
run_suite "model fallback transaction suite" python3 "$ROOT/ci/model-fallback-test.py"
...
run_suite "legacy closeout suite" python3 "$ROOT/ci/legacy-closeout-test.py"
run_suite "terminal backfill suite" python3 "$ROOT/ci/terminal-backfill-test.py"
