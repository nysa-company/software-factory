...
- Do not edit or append `Kit-SHA`, priority, Initiative, or operator-owned state transitions. The trusted wrapper owns `Kit-SHA`; the dispatcher owns the Planning stage, and the reconciler projects your output.
