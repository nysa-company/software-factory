...
|---|---|---|
| Internal change | Behavior visible only inside the app; no external side effects, no schema change | Summary, preview link, screenshots, criteria table, cost, revert one-liner |
