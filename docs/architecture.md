...
source guards name a Builder or Test-author path unless that test is both an
exact declared conflict and a Fixture-Seam; semantic and dynamic guards remain
the Planner and Spec-linter's fail-closed responsibility.
