...
RULES = (
    ...
    ("handoff", r"handoff|journal|worktree|commit|revision|repository|filesystem|tracked|index|symlink|hardlink|file|path|branch|snapshot|binary|secret|provider-authored|tree|submodule|fallback|migration|content|utf-?8"),
