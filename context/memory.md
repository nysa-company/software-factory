...
- Hermes contract 1.6 retains Contract 1.5 behavior and expands only its active capacity bound to six while preserving compatibility with active 1.0–1.5 releases.
